 ...
 *
 * @size: ulong int represents size of a new sorted hash table.
 *
...
/**
 * shash_table_set - Add element to the sorted hash table. Key collisions
...
/**
 * insert_sorted - Places new element in correct position of a sorted
 * hash table.
 *
...
/**
 * shash_table_delete - Deletes a sorted hash tableand  fres up memory and
 * set the `ht` to NULL.
 *
 * @ht: Pointer to hash table.
 */
